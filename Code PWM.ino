...
//jika hanya sensor 1 yang mendeteksi gelap, maka error terdeteksi dan menjalankan perintah terdekat
if (baca_sensor[0] < 34 && baca_sensor[1] > 34 && 
    baca_sensor[2] > 34 && baca_sensor[3] > 34 && 
    baca_sensor[4] > 34 && baca_sensor[5] > 34){
  digitalWrite (pinEnable, HIGH);
...
//jika hanya sensor 2 yang mendeteksi gelap, maka error terdeteksi dan menjalankan perintah terdekat
if (baca_sensor[0] > 34 && baca_sensor[1] < 34 && 
    baca_sensor[2] > 34 && baca_sensor[3] > 34 && 
    baca_sensor[4] > 34 && baca_sensor[5] > 34){
  digitalWrite (pinEnable, HIGH);
...
//jika hanya sensor 3 yang mendeteksi gelap, maka error terdeteksi dan menjalankan perintah terdekat
if (baca_sensor[0] > 34 && baca_sensor[1] > 34 && 
    baca_sensor[2] < 34 && baca_sensor[3] > 34 && 
    baca_sensor[4] > 34 && baca_sensor[5] > 34){
  digitalWrite (pinEnable, HIGH);
...
//jika hanya sensor 4 yang mendeteksi gelap, maka error terdeteksi dan menjalankan perintah terdekat
if (baca_sensor[0] > 34 && baca_sensor[1] > 34 && 
    baca_sensor[2] > 34 && baca_sensor[3] < 34 && 
    baca_sensor[4] > 34 && baca_sensor[5] > 34){
  digitalWrite (pinEnable, HIGH);
...
//jika hanya sensor 5 yang mendeteksi gelap, maka error terdeteksi dan menjalankan perintah terdekat
if (baca_sensor[0] > 34 && baca_sensor[1] > 34 && 
    baca_sensor[2] > 34 && baca_sensor[3] > 34 && 
    baca_sensor[4] < 34 && baca_sensor[5] > 34){
  error = 1;
...
//jika hanya sensor 6 yang mendeteksi gelap, maka error terdeteksi dan menjalankan perintah terdekat
if (baca_sensor[0] > 34 && baca_sensor[1] > 34 && 
    baca_sensor[2] > 34 && baca_sensor[3] > 34 && 
    baca_sensor[4] > 34 && baca_sensor[5] < 34){
  digitalWrite (pinEnable, HIGH);
